// Content extracted from "ACRI CR Workshop Aug 2026.pdf", mapped to the
// AI Workshop reference page's sections. Fields with no source content use
// the literal placeholder "Content Coming Soon" (approved placeholder copy).

export const hero = {
  badge: 'Content Coming Soon',
  title:
    'Conference & Certification Workshop on Clinical Research Methodology, Biostatistics & Evidence-Based Healthcare – 2026',
  paragraph:
    "This national academic initiative is designed to strengthen India's clinical research ecosystem by providing structured training in clinical research methodology, biostatistics, scientific writing, evidence-based medicine, regulatory science, and data analysis. The conference aims to bridge the gap between academia, healthcare institutions, industry, and clinical research organizations while nurturing future investigators and research professionals.",
}
...
export const statBar = {
  credit: { title: 'Content Coming Soon', caption: 'Content Coming Soon' },
  notice: 'Content Coming Soon',
}

export const whyAttend = {
  audience:
    'Target audience for this workshop: Medical Faculty, Clinicians & Specialists, MD/MS/DNB/DrNB Residents, MBBS Students, Allied Health Professionals, Researchers (Post docs), Pharmaceutical Professionals, Clinical Research Professionals, CRO Professionals, Biostatisticians, Medical Writers, and Public Health Professionals.',
  topics: [
    { iconKey: 'methodology', title: 'Clinical Research Methodology', description: 'Content Coming Soon' },
    { iconKey: 'ebm', title: 'Principles of Evidence-Based Medicine', description: 'Content Coming Soon' },
    { iconKey: 'biostatistics', title: 'Fundamentals of Biostatistics', description: 'Content Coming Soon' },
    { iconKey: 'spss', title: 'SPSS Hands-on Training', description: 'Content Coming Soon' },
    { iconKey: 'writing', title: 'Scientific Writing (IMRAD)', description: 'Content Coming Soon' },
    { iconKey: 'literature', title: 'Literature Search & Reference Management (Zotero)', description: 'Content Coming Soon' },
    { iconKey: 'rct', title: 'Randomized Controlled Trials', description: 'Content Coming Soon' },
    { iconKey: 'systematic', title: 'Systematic Reviews & Meta-analysis', description: 'Content Coming Soon' },
    { iconKey: 'protocol', title: 'Protocol Development', description: 'Content Coming Soon' },
    { iconKey: 'ethics', title: 'Ethics & Good Clinical Practice (GCP)', description: 'Content Coming Soon' },
    { iconKey: 'regulatory', title: 'Regulatory Perspectives', description: 'Content Coming Soon' },
    { iconKey: 'publication', title: 'Publication Strategies', description: 'Content Coming Soon' },
    { iconKey: 'caseDiscussion', title: 'Interactive Case Discussions', description: 'Content Coming Soon' },
  ],
}

export const schedule = {
  titleLine: 'Content Coming Soon',
  venueLine: 'Content Coming Soon',
...
export const contact = {
  ...
  titleLines: [
    'MBBS., MHA(USA)., FID., FFM',
    'Post Doc – Georgetown University (USA)',
    'Vice President – ASRAM',
    'Organising Secretary, ACRI Conference 2026',
  ],
  email: 'Content Coming Soon',
  phone: 'Content Coming Soon',
  address: 'ASRAM Medical College, Eluru, Andhra Pradesh',
  mapEmbedSrc: 'https://www.google.com/maps?q=ASRAM+Medical+College+Eluru+Andhra+Pradesh&output=embed',
  mapsLink:
    'https://www.google.com/maps/search/?api=1&query=ASRAM+Medical+College+Eluru+Andhra+Pradesh',
}
